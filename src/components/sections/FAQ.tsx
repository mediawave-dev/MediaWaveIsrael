...
const faqItems: { question: ReactNode; answer: ReactNode }[] = [
  {
    ...
    answer: <>אנחנו בונים עבורך תשתית עבודה מלאה, לא רק "דף באינטרנט". החבילה כוללת עד 5 עמודים בעיצוב מותאם אישית (רספונסיבי), אופטימיזציה מלאה למובייל, חיבור ישיר ל-<En>WhatsApp</En> וטופסי לידים חכמים. אנחנו מתחייבים לאתר שעובד מהר וממיר גולשים ללקוחות.</>,
  },
  {
    question: 'האם יש דמי מנוי חודשיים?',
    answer: 'בניגוד להרבה חברות בשוק, אצלנו האתר בבעלותכם המלאה. אין "שכירות" חודשית ואין אותיות קטנות. אתם משלמים פעם אחת על הפיתוח, וזהו. למי שרוצה ראש שקט באמת, אנחנו מציעים חבילות תחזוקה אופציונליות לעדכונים וגיבויים – אבל זו בחירה שלכם, לא חובה.',
  },
  {
  ...
  },
  {
    ...
    answer: 'זה פשוט: קובעים שיחת אפיון קצרה (ללא התחייבות). נבין מה המטרות שלכם, תקבלו הצעת מחיר מסודרת, וברגע שיוצאים לדרך – אנחנו לוקחים את המושכות ומובילים אתכם עד להשקה.',
  },
]
