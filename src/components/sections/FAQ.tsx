...
const faqItems: { question: ReactNode; answer: ReactNode }[] = [
  {
    ...
    answer: <>אנחנו בונים עבורך תשתית עבודה מלאה, לא רק "דף באינטרנט". יש לנו שלוש חבילות מותאמות, מדף נחיתה ועד פרויקט מורכב. כל אחת כוללת עיצוב מותאם אישית, רספונסיביות מלאה, וחיבור ל-<En>WhatsApp</En> וטופסי לידים חכמים. לפירוט המלא, ראו את <a href="#packages" className="text-orange hover:text-orange-dark font-semibold">החבילות שלנו</a> למעלה.</>,
  },
  {
    question: 'האם יש דמי מנוי חודשיים?',
    answer: <>בניגוד להרבה חברות בשוק, אצלנו האתר בבעלותכם המלאה. אין "שכירות" חודשית ואין אותיות קטנות. אתם משלמים פעם אחת על הפיתוח, וזהו. למי שרוצה ראש שקט באמת, אנחנו מציעים חבילות תחזוקה אופציונליות לעדכונים וגיבויים, אבל זו בחירה שלכם, לא חובה. לפירוט המחירים, ראו את <a href="#packages" className="text-orange hover:text-orange-dark font-semibold">החבילות שלנו</a>.</>,
  },
  {
  ...
  },
  {
    ...
    answer: <>זה פשוט: קובעים שיחת אפיון קצרה (ללא התחייבות). נבין מה המטרות שלכם, נתאים את <a href="#packages" className="text-orange hover:text-orange-dark font-semibold">החבילה המתאימה</a>, וברגע שיוצאים לדרך אנחנו לוקחים את המושכות ומובילים אתכם עד להשקה.</>,
  },
]
