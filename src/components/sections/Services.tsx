...
const services: Service[] = [
  {
    ...
    description:
      'לא תבניות — קוד מאפס. React, Next.js או WordPress — הטכנולוגיה נבחרת לפי מה שהעסק באמת צריך. התוצאה: אתר מהיר, מאובטח, ושלכם ב-100%.',
    icon: Monitor,
    span: 2,
  ...
  },
  {
    ...
    description:
      'דף אחד, מטרה אחת: להפוך גולשים ללידים. מבנה ממוקד המרה, קריאות לפעולה חכמות, וחיבור ישיר ל-WhatsApp או טופס לידים.',
    icon: Target,
    span: 1,
  },
  {
    ...
    description:
      'הרושם הראשון הוא דיגיטלי. נבנה לכם נוכחות אונליין שגורמת ללקוחות לסמוך עליכם עוד לפני שהרימו טלפון.',
    icon: Building2,
    span: 1,
  },
  {
    ...
    description:
      'מה שווה אתר מדהים אם אף אחד לא מוצא אותו? מחקר מילות מפתח, תוכן ממוקד, ומבנה טכני נכון — כדי שגוגל יעבוד בשבילכם.',
    icon: Search,
    span: 2,
  ...
  },
  {
    ...
    description:
      'לא נעלמים אחרי ההשקה. עדכוני אבטחה, גיבויים אוטומטיים, ותמיכה ישירה מהמפתח — בלי תורות תמיכה ובלי צד שלישי.',
    icon: LifeBuoy,
    span: 1,
  },
  {
    ...
    description:
      '70% מהגולשים בישראל גולשים מהנייד. כל אתר נבנה Mobile-First — חוויית המובייל היא לא התאמה בדיעבד, היא נקודת ההתחלה.',
    icon: Smartphone,
    span: 2,
