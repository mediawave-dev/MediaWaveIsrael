...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ===== LAYER 3: Content (z-[2]) ===== */}
      <motion.div
        className="relative z-[2] container pt-32 pb-32"
        style={{ opacity }}
      >
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <motion.span
            className="inline-flex items-center gap-2 bg-white/10 text-white text-base font-semibold px-5 py-2.5 rounded-full mb-8 backdrop-blur-sm border border-white/20"
          ...
          {/* Main Headline */}
          <motion.h1
            className="text-5xl md:text-6xl lg:text-7xl font-headline leading-tight mb-6"
          ...
          {/* Typewriter Section */}
          <motion.div
            className="text-3xl md:text-4xl lg:text-5xl text-white mb-4 min-h-[1.4em]"
          ...
          {/* CTA Buttons */}
          <motion.div
            className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center mb-16"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <motion.a
              href="#contact"
              className="group relative overflow-hidden bg-orange text-lg font-semibold py-4 px-10 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 focus-visible:ring-2 focus-visible:ring-orange focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              style={{ color: '#FFFFFF' }}
            ...
            <motion.a
              href="#portfolio"
              className="border-2 border-white hover:bg-white hover:text-brown-dark text-white text-lg font-semibold py-4 px-10 rounded-full transition-all duration-300 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
              whileHover={{ scale: 1.02, y: -2 }}
              whileTap={{ scale: 0.98 }}
            >
              לפרויקטים שלנו
          ...
          >
            {[
              ...
              >
                <span className="text-3xl font-headline text-orange">{stat.value}</span>
