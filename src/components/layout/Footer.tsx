    ...
    <footer className="relative bg-cream-dark overflow-hidden">
      ...
      <div className="container relative py-16 md:py-20">
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          ...
          {/* Navigation Column */}
          <div className="md:col-span-1">
            <h3 className="font-headline text-lg text-brown-dark mb-6">ניווט</h3>
          ...
          {/* Contact Column */}
          <div className="md:col-span-1">
            <h3 className="font-headline text-lg text-brown-dark mb-6">צור קשר</h3>
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-brown-dark" dir="ltr">052-8731808</span>
              </a>
              ...
              <a
                ...
                className="flex items-center gap-3 text-brown hover:text-orange transition-colors duration-300 group"
              >
                <span className="w-10 h-10 flex items-center justify-center rounded-full bg-cream group-hover:bg-orange/10 transition-colors duration-300 flex-shrink-0">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="20" height="16" x="2" y="4" rx="2"/>
                    <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
                  </svg>
                </span>
                <span className="text-xs sm:text-sm font-english truncate text-brown-dark" dir="ltr">mediawaveisrael@gmail.com</span>
              </a>
              ...
              >
                ...
                <span className="font-english text-brown-dark">WhatsApp</span>
              </a>
            </div>
          </div>
        </div>
      ...
      {/* Floating WhatsApp Button with glow pulse - z-30 to stay below modals but above content */}
      <motion.a
        href="https://wa.me/972528731808?text=%D7%94%D7%99%D7%99%2C%20%D7%90%D7%A0%D7%99%20%D7%9E%D7%AA%D7%A2%D7%A0%D7%99%D7%99%D7%9F%2F%D7%AA%20%D7%91%D7%91%D7%A0%D7%99%D7%99%D7%AA%20%D7%90%D7%AA%D7%A8%20%D7%95%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%A9%D7%9E%D7%95%D7%A2%20%D7%A4%D7%A8%D7%98%D7%99%D7%9D%20%D7%A0%D7%95%D7%A1%D7%A4%D7%99%D7%9D%20%F0%9F%98%8A"
        target="_blank"
        rel="noopener noreferrer"
