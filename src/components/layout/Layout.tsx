...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-cream relative">
      ...
      {/* AI Chat widget — bottom-left, lowest position */}
    ...
    <AnimatePresence>
      {!isChatOpen && (
        <motion.a
          ...
          className="fixed bottom-20 left-4 sm:bottom-24 sm:left-6 z-30 h-12 sm:h-14 bg-[#25D366] rounded-full shadow-lg flex items-center gap-2 px-3 sm:px-4"
