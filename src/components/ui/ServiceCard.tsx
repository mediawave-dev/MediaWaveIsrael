...
const accentColors = {
  orange: {
    ...
    blob: 'rgba(125, 211, 252, 0.20)',
    hover: 'rgba(240, 249, 255, 1)',
    icon: '#7DD3FC',
    glow: 'rgba(125, 211, 252, 0.45)',
  },
  terracotta: {
    bg: 'rgba(103, 232, 249, 0.10)',
    blob: 'rgba(103, 232, 249, 0.18)',
    hover: 'rgba(236, 254, 255, 1)',
    icon: '#67E8F9',
    glow: 'rgba(103, 232, 249, 0.4)',
  },
  coral: {
    bg: 'rgba(165, 243, 252, 0.10)',
    blob: 'rgba(165, 243, 252, 0.18)',
    hover: 'rgba(236, 254, 255, 1)',
    icon: '#A5F3FC',
  ...
  sage: {
    ...
    blob: 'rgba(153, 246, 228, 0.18)',
    hover: 'rgba(240, 253, 250, 1)',
    icon: '#99F6E4',
