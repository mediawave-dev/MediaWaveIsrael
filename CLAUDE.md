...
Strategic + visual design docs generated by `/impeccable init` (2026-07-05):
- `PRODUCT.md` — register (brand), users, personality, anti-references, principles.
- `DESIGN.md` — the design system: tokens, named rules (Sky-Ink, Legacy-Name,
  One-Accent), signature components, Do's & Don'ts. Read BOTH before design work;
  they encode Nati's locked taste rules (DECISIONS.rtl.md #26-36).
