...
<html lang="he" dir="rtl"><head><meta charset="utf-8"><style>
  ...
  <div class="top"><h1>שלמה שיפוצים ובניה בע"מ</h1><p>*** האתר הרשמי *** מקצועיות מעל הכל ***</p></div>
  <div class="marq">★★★ ברוכים הבאים לאתר החדש שלנו!!! מבצע חורף — 10% הנחה לכל המזמינים החודש!!! ★★★</div>
  <div class="navbar"><a>דף הבית</a><a>אודות</a><a>שירותים</a><a>גלריה</a><a>מחירון</a><a>צור קשר</a><a>ספר אורחים</a></div>
  <div class="wrap">
    <div class="main">
      <div class="box"><h2>ברוכים הבאים!!!</h2>
        <p>אנחנו חברה משפחתית עם ניסיון רב בתחום. אצלנו תקבלו שירות אמין, מהיר ומקצועי במחירים ללא תחרות. אנחנו מאמינים שהלקוח תמיד צודק ולכן נעשה הכל כדי שתהיו מרוצים.</p>
        <p class="blink">!!! חדש !!! עכשיו גם עבודות גבס ואינסטלציה !!!</p>
        <span class="btn">לחץ כאן לפרטים</span>
      </div>
      <div class="box"><h2>המחירון שלנו</h2>
        <table class="prices"><tr><th>שירות</th><th>מחיר</th></tr>
        <tr><td>צביעת דירה 3 חדרים</td><td>לפי בקשה</td></tr>
        <tr><td>שיפוץ אמבטיה</td><td>התקשרו</td></tr>
        <tr><td>ריצוף</td><td>מחיר מיוחד!</td></tr></table>
      </div>
      <div class="counter">אתם המבקר מספר 003842 באתר | עודכן לאחרונה: 12/03/2011</div>
    </div>
    <div class="side">
      <h3>ניווט מהיר</h3><ul><li>המלצות</li><li>תמונות מהשטח</li><li>טופס הזמנה</li><li>שאלות ותשובות</li></ul>
      <h3>צור קשר</h3><p>טל: 03-1234567<br>פקס: 03-1234568<br>שעות פעילות:<br>א-ה 8:00-17:00</p>
      <h3>חדשות</h3><p>האתר עלה לאוויר! תודה לבני הדוד שבנה</p>
    </div>
  </div>
  <div class="footer">כל הזכויות שמורות © 2011 | האתר נבנה באהבה | מומלץ לצפייה ברזולוציה 1024x768</div>
</body></html>`
